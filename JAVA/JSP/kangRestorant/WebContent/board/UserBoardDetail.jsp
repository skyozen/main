				...
				<div class="contentInnerWrap">
					...
					<section class="">
						...
						<div class="boarddetail">
							...
							BoardBean bl=(BoardBean)boardList.get(num);
							--%>
								...
								<tr>
									...
									<td style="font-family: 돋음; font-size: 12"><%=board.getBO_SUBJECT()%>
									</td>
								</tr>
								...
								<tr align="center" valign="middle">
									<td colspan="5"><font size=2> <a
											href="BoardReplyAction.bo?num=<%=board.getBO_NO()%>">
												[답변] </a>&nbsp;&nbsp; <a
											href="BoardModify.bo?num=<%=board.getBO_NO()%>"> [수정] </a>&nbsp;&nbsp;
											<a href="./BoardDeleteAction.bo?num=<%=board.getBO_NO()%>">
												[삭제] </a>&nbsp;&nbsp; <a href="BoardList.bo">[목록]</a>&nbsp;&nbsp;
									</font></td>
								</tr>
							</table>
